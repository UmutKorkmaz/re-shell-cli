...
export interface BackendTemplate extends BaseTemplate {
  framework: string;
  displayName: string;
  language: 'typescript' | 'javascript' | 'python' | 'rust' | 'go' | 'java' | 'csharp' | 'php' | 'ruby' | 'lua' | 'cpp' | 'kotlin' | 'scala' | 'elixir' | 'swift' | 'dart' | 'crystal' | 'zig' | 'nim' | 'v' | 'gleam' | 'haskell' | 'fsharp' | 'clojure' | 'perl' | 'julia' | 'deno' | 'bun' | 'ocaml' | 'odin' | 'pony' | 'red';
  port?: number;
